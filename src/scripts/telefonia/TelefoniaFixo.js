...
class TelefoniaFixo extends React.Component {
    constructor(props) {
        super(props);
        this.handleChange9 = this.handleChange9.bind(this);
        this.getTextFixo = this.getTextFixo.bind(this);
        this.state = {
            contato1: '',
            mcontato: '',
            contato2: '',
...
- Tentou reiniciar os equipamentos?
R: ${this.state.reboot}
        
- Caso esteja com problemas para fazer ligações para números específicos, informe os números de exemplo:
R: ${this.state.prob}
        
- Telefone do cliente esta mudo?
R: ${this.state.telMudo}
    ...
    render() {
        return (
            <div style={{ fontSize: 18, margin: '10px' }}>
                <div style={{ textAlign: 'center' }}> <label><b>TELEFONIA FIXA</b></label>   </div>
                <br />
                <label>
                    <b>
                        Descreva detalhadamente  a reclamação/solicitação do cliente.
                ...
                <label>
                    ...
                    <br />
                    <input type="text" style={{ width:400 }}name="reboot" value={this.state.reboot} onChange={(e) => this.setState({ reboot: e.target.value })} />
                </label>
                <br />
                <label>
                    <b>
                    ...
                    <br />
                    <input type="text" style={{ width:400 }}name="prob" value={this.state.prob} onChange={(e) => this.setState({ prob: e.target.value })} />
                </label>
                <br />
                <label>
                    <b>
                    ...
                    <br />
                    <input type="text" style={{ width:400 }}name="telMudo" value={this.state.telMudo} onChange={(e) => this.setState({ telMudo: e.target.value })} />
                </label>
                <br />
                <label>
                    <b>
                ...
                <div style={{ textAlign: 'center' }}>
                    <Clipboard option-text={this.getTextFixo}>
                        COPIAR
                    </Clipboard>
