...
class SinalAtenuado extends React.Component {
    constructor(props) {
        super(props);
        this.handleChange9 = this.handleChange9.bind(this);
        this.getTextSina = this.getTextSina.bind(this);
        this.state = {
            upppoe: '',
            spppoe: '',
            sinal: '',
    ...
    getTextSina() {
        return `MANUTENÇÃO - SINAL ATENUADO
    ...
    render() {
        return (
            <div style={{ fontSize: 18, margin: '10px' }}>
                <div style={{ textAlign: 'center' }}><label><b>MANUTENÇÃO - SINAL ATENUADO</b></label></div>
                <br />
                <label>
                    <b>
                ...
                <div style={{ textAlign: 'center' }}>
                    <Clipboard option-text={this.getTextSina}>
                        COPIAR
                    </Clipboard>
